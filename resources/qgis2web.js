...
map.getView().fit([1786495.251499, -44554.939767, 2874570.758749, 510243.595690], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte de Mongala</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (51 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Il s\'agit d\'une carte web des secteurs d\'activités ';
            }
